  ...
  return <main id="top">
    ...
    <div className="dark-shell">
      <header className="header wrap">
        <a className="brand" href="#top" aria-label="RentZal — на главную"><img src="/brand/mainlogo.svg" width="34" height="40" alt=""/><span>rent<span className="lime">.</span>zal</span></a>
      ...
      <section className="hero wrap" aria-labelledby="hero-title">
        ...
        <div className="hero-visual"><img className="hero-photo" src="/images/basketball.jpg" alt="Любительская баскетбольная игра в спортивном зале" width="1800" height="1200" fetchPriority="high"/>
      ...
      <div className="wrap inside-grid">
        ...
        <div className="demo-stage">
          ...
          <article className="game-preview" aria-label="Пример карточки игры, не действительное предложение">
            <div className="preview-image"><img src="/images/basketball.jpg" width="1800" height="1200" loading="lazy" alt="Баскетбол на крытой площадке"/><span>БАСКЕТБОЛ</span><span className="example-tag">ПРИМЕР ИГРЫ</span></div>
